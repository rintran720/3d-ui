...
const videoButtonVariants = cva([
  ...
  "bg-surface-700/90 backdrop-blur-sm",
  ...
  // 3D effect
  "shadow-[0_2px_0_0_rgba(0,0,0,0.2),0_4px_8px_-2px_rgba(0,0,0,0.3)]",
  "hover:bg-surface-600/90",
  "hover:shadow-[0_3px_0_0_rgba(0,0,0,0.2),0_6px_12px_-3px_rgba(0,0,0,0.35)]",
  "active:shadow-[0_1px_0_0_rgba(0,0,0,0.2),0_2px_4px_-1px_rgba(0,0,0,0.25)]",
]);
...
const videoProgressVariants = cva(
  [
    ...
    "cursor-pointer",
    "transition-all duration-200",
    "shadow-[inset_0_2px_4px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.05)]",
    "hover:bg-surface-700/40",
    "hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.08)]",
  ],
  {
    variants: {
      size: {
...
const videoProgressBarVariants = cva([
  ...
  "group-hover:shadow-[0_2px_4px_rgba(59,130,246,0.3),inset_0_1px_0_rgba(255,255,255,0.2)]",
      ...
      >
        ...
        {showVolumeIndicator && (
          <div className="absolute bottom-20 left-1/2 -translate-x-1/2 pointer-events-none z-20">
            <div className="bg-surface-800/90 backdrop-blur-sm border border-surface-700 rounded-2xl px-6 py-4 shadow-[0_4px_0_0_rgba(0,0,0,0.15),0_8px_16px_-4px_rgba(0,0,0,0.2)]">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-surface-100 font-semibold text-sm min-w-[3rem] text-right">
        ...
        {!isPlaying && !isLoading && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
            <button
              ...
              className="pointer-events-auto w-20 h-20 rounded-full bg-surface-800/90 backdrop-blur-sm border-2 border-surface-600 flex items-center justify-center transition-all duration-200 shadow-[0_4px_0_0_rgba(0,0,0,0.15),0_8px_16px_-4px_rgba(0,0,0,0.2)] hover:bg-surface-700/90 hover:border-surface-500 hover:shadow-[0_6px_0_0_rgba(0,0,0,0.15),0_12px_24px_-4px_rgba(0,0,0,0.25)] hover:scale-110 active:scale-95 active:shadow-[0_2px_0_0_rgba(0,0,0,0.1),0_4px_8px_-2px_rgba(0,0,0,0.15)]"
              aria-label="Play"
            >
              <svg
                className="w-10 h-10 text-surface-100"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="w-20 flex items-center">
                  <input
                    ...
                    className="w-full h-1 bg-surface-700 rounded-full appearance-none cursor-pointer accent-primary-500"
                  />
                </div>
              </div>

              {/* Time */}
              <div className="text-surface-100 text-sm font-mono ml-auto">
