...
const carouselDotVariants = cva(
  [
    ...
    // 3D effect
    "shadow-[inset_0_1px_2px_rgba(0,0,0,0.3),0_1px_0_rgba(255,255,255,0.1)]",
    "hover:bg-surface-500",
    "hover:shadow-[inset_0_1px_2px_rgba(0,0,0,0.25),0_1px_0_rgba(255,255,255,0.15)]",
    "hover:scale-110",
  ],
  {
    variants: {
      active: {
        true: [
          ...
          "border-primary-400",
          "w-6",
          "shadow-[0_2px_0_0_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.2)]",
        ],
        false: "",
      },
    },
