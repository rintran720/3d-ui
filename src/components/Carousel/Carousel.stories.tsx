        ...
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Slide 1</h3>
              <p className="text-surface-300">This is the first slide content.</p>
            </CardContent>
          </Card>
        </CarouselItem>
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Slide 2</h3>
              <p className="text-surface-300">This is the second slide content.</p>
            </CardContent>
          </Card>
        </CarouselItem>
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Slide 3</h3>
              <p className="text-surface-300">This is the third slide content.</p>
            </CardContent>
          </Card>
        </CarouselItem>
      </Carousel>
        ...
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center bg-gradient-to-br from-primary-500/20 to-primary-700/20">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Auto-playing Slide 1</h3>
              <p className="text-surface-300">This carousel auto-plays every 3 seconds.</p>
            </CardContent>
          </Card>
        </CarouselItem>
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center bg-gradient-to-br from-secondary-500/20 to-secondary-700/20">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Auto-playing Slide 2</h3>
        ...
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center bg-gradient-to-br from-accent-500/20 to-accent-700/20">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Auto-playing Slide 3</h3>
      ...
      <Carousel {...args}>
        ...
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Slide 3</h3>
              <p className="text-surface-300">Keyboard navigation still works.</p>
            </CardContent>
          </Card>
        </CarouselItem>
      </Carousel>
      ...
      <Carousel {...args}>
        ...
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Slide 2</h3>
              <p className="text-surface-300">Use navigation buttons or swipe.</p>
            </CardContent>
          </Card>
        </CarouselItem>
        <CarouselItem>
      ...
      <Carousel {...args}>
          ...
          <Card className="m-2">
            <CardContent className="p-6">
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-surface-100">Product Feature 1</h3>
        ...
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-6">
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-surface-100">Product Feature 2</h3>
                <p className="text-surface-300">
        ...
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-6">
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-surface-100">Product Feature 3</h3>
                <p className="text-surface-300">
    ...
    <div className="w-[600px]">
      <Carousel {...args}>
        <CarouselItem>
          <Card className="m-2">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4 text-surface-100">Elevated Variant</h3>
